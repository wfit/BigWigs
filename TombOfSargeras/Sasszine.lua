...
do
	...
	function mod:HydraShot(args)
		...
		if count == 1 then
			...
			self:Bar(args.spellId, self:Mythic() and ((stage == 3 and hydraShotCounter <= 4 and 31.5) or 30.5) or stage == 2 and 30 or 40, CL.count:format(args.spellName, hydraShotCounter))
		end
