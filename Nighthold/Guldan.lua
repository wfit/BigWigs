...
local timersHeroic = {
	...
	[3] = {
		...
		[209270] = { 30.6, 62.5, 62.5, 25.0, 84.2 },
		-- Storm of the Destroyer, SPELL_CAST_START
		[167819] = { 75.8, 68.8, 61.2, 64.6 },
		-- Soul Siphon, SPELL_AURA_APPLIED
		[221891] = { 24.8, 10.2, 49.0, 10.2, 10.2, 59.0, 10.3, 10.2, 10.2, 45.2, 9.5, 9.5, 9.5, 9.5 },
		-- Black Harvest, SPELL_CAST_START
		[206744] = { 55.8, 72.5, 87.6, 86.7 },
	}
}
...
local timersMythic = {
	...
	[3] = {
		-- Empowered Eye of Gul'dan, SPELL_CAST_START
		[209270] = { 26.7, 52.6, 53.2, 20.4 },
		-- Storm of the Destroyer, SPELL_CAST_START
		[167819] = { 64.5, 57.8, 51.5 },
		-- Soul Siphon, SPELL_AURA_APPLIED
