...
local db = nil
local normalAnchor, emphasizeAnchor, impactAnchor = nil, nil, nil
...
function plugin:StartImpactBar(_, module, key, text, time, icon, color)
	...
	local bar = candy:New(media:Fetch(STATUSBAR, db.texture), db.BigWigsImpactAnchor_width, db.BigWigsImpactAnchor_height)
	bar.candyBarBackground:SetVertexColor(colors:GetColor("barBackground", module, key))
	bar:Set("bigwigs:module", module)
